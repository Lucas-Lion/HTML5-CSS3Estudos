...
<body>
    ...
    <div class="container-0">
        <img id="logo" src="../img/caixas/placa-grafica.png" alt="Placa de vídeo" />
    </div>
    <h1>Peças</h1>
    <hr>
    <main>
        ...
        <div class="container-1">
          <a class="link-shadow" href="memorias.php" target="_self">
            <div class="shadow">
                <div id="caixa-0" class="caixas">
                    <p class="legenda">Memórias</p>
                </div>
            </div>
          </a>
