...
<body class="bg-light">
    ...
    <div class="container text-center text-dark mb-5">
        <h1>
            Lista Telefônica da Prefeitura
        </h1>
        <p class="subtitle">
            Seja bem vindo(a) a lista telefônica da prefeitura!
        </p>
    </div>
    ...
    <div class="container-fluid pe-5 ps-5 pt-4">
        <table class="table table-striped table-hover margin-table">
            <thead class="text-center">
              <tr>
                <th scope="col" class="text-light" style="background-color: #082C4D;">Local</th>
                <th scope="col" class="text-light" style="background-color: #082C4D;">Nome</th>
